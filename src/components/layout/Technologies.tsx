  ...
  return (
    <div className="flex justify-center items-center  text-white h-full w-full">
      <div className="w-[65%] flex flex-col h-[90%] items-center mt-52">
        ...
        <div className="w-full h-[90%] mt-32 flex justify-between gap-7 flex-wrap px-52 bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-[#D0BFFF]/[0.32]">
          ...
          <Image src={db} alt="" height="150" width="150" />
        </div>
      </div>
    </div>
  );
